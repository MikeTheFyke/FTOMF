...
TweenMax.to('#deer-sensor-outer', 1, { scale: 1, yoyo: 1, repeat: -1, transformOrigin: "center" })
TweenMax.to('#deer-sensor', 1, { scale: 1, yoyo: 1, repeat: -1, transformOrigin: "center" })
...
document.getElementById('deer-sensor').addEventListener('mouseover', function(){
    ...
    TweenMax.to('#deer-sensor-outer', 1, { opacity: 0, zIndex: 0 })
    TweenMax.to('#deer-sensor', 1, { opacity: 0, zIndex: 0 })
});